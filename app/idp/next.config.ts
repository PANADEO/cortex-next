  ...
  async rewrites() {
    return {
      beforeFiles: [
        ...
        {
          source: "/packages/:pid/transport-orders/:oid/consignor",
          has: [{ type: "header", key: "accept", value: ".*application/json.*" }],
          destination: `${IDP_BACKEND_URL}/packages/:pid/transport-orders/:oid/consignor`,
        },
        {
          source: "/packages/:pid/transport-orders/:oid/consignee",
          has: [{ type: "header", key: "accept", value: ".*application/json.*" }],
          destination: `${IDP_BACKEND_URL}/packages/:pid/transport-orders/:oid/consignee`,
        },
        {
          source: "/packages/:pid/transport-orders/:oid/transport-info",
          has: [{ type: "header", key: "accept", value: ".*application/json.*" }],
          destination: `${IDP_BACKEND_URL}/packages/:pid/transport-orders/:oid/transport-info`,
        },
        {
          source: "/packages/:pid/transport-orders/:oid/invoices/:iid",
          has: [{ type: "header", key: "accept", value: ".*application/json.*" }],
          destination: `${IDP_BACKEND_URL}/packages/:pid/transport-orders/:oid/invoices/:iid`,
        },
        {
          source: "/packages/:pid/transport-orders/:oid/invoices/:iid/totals",
          has: [{ type: "header", key: "accept", value: ".*application/json.*" }],
          destination: `${IDP_BACKEND_URL}/packages/:pid/transport-orders/:oid/invoices/:iid/totals`,
        },
        {
          source: "/packages/:pid/transport-orders/:oid/invoices/:iid/delivery-terms",
          has: [{ type: "header", key: "accept", value: ".*application/json.*" }],
          destination: `${IDP_BACKEND_URL}/packages/:pid/transport-orders/:oid/invoices/:iid/delivery-terms`,
        },
        {
          source: "/packages/:pid/transport-orders/:oid/invoices/:iid/lines",
          has: [{ type: "header", key: "accept", value: ".*application/json.*" }],
          destination: `${IDP_BACKEND_URL}/packages/:pid/transport-orders/:oid/invoices/:iid/lines`,
        },
