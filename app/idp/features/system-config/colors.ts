...
const TILE_COLORS: Record<string, TileColorClasses> = {
  ...
  indigo: { iconBg: "bg-indigo-200 dark:bg-indigo-900/40", iconFg: "text-indigo-700 dark:text-indigo-300" },
  amber: { iconBg: "bg-amber-200 dark:bg-amber-900/40", iconFg: "text-amber-700 dark:text-amber-300" },
  emerald: {
    iconBg: "bg-emerald-200 dark:bg-emerald-900/40",
    iconFg: "text-emerald-700 dark:text-emerald-300",
  },
  violet: { iconBg: "bg-violet-200 dark:bg-violet-900/40", iconFg: "text-violet-700 dark:text-violet-300" },
  slate: { iconBg: "bg-slate-200 dark:bg-slate-800/60", iconFg: "text-slate-700 dark:text-slate-300" },
  teal: { iconBg: "bg-teal-200 dark:bg-teal-900/40", iconFg: "text-teal-700 dark:text-teal-300" },
  orange: { iconBg: "bg-orange-200 dark:bg-orange-900/40", iconFg: "text-orange-700 dark:text-orange-300" },
...
export const TILE_COLOR_OPTIONS: ReadonlyArray<{ value: string; label: string } & TileColorClasses> = [
