...
// requireTileAccess(). Grant ZBIORCZY: `show_on_hub=false` w seedzie, sam
// kod nigdy nie renderuje własnej karty na hubie — bramkuje "wszystkie
// narzędzia AI naraz" (canAccessAiTool w app/idp/lib/ai-tools/app-codes.ts).
