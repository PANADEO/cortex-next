...
| Konfiguracja Systemu (Ścieżka E, budowane) | users/role/permissions/rejestr kafelków | — (jeszcze nie istnieje) | Postgres, schema `konfiguracja_systemu`, od startu na docelowym wzorcu |
