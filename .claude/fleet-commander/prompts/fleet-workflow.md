...
<!-- Placeholders cortex-frontend, cortex-frontend, main, {{ISSUE_NUMBER}} are replaced during installation. -->

# Diamond Workflow — cortex-frontend
...
```
User: claude --worktree cortex-frontend-{N}
