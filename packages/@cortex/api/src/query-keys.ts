...
export const queryKeys = {
  ...
  moduleVersion: (endpoint: string) => [...queryKeys.all, "module-version", endpoint] as const,
  ...
  packages: {
    ...
    list: (query: GetPackagesQuery) => [...queryKeys.packages.all(), "list", query] as const,
    detail: (id: string) => [...queryKeys.packages.all(), "detail", id] as const,
    actions: (id: string) => [...queryKeys.packages.all(), "actions", id] as const,
    transportOrders: (id: string) => [...queryKeys.packages.all(), "transport-orders", id] as const,
    ...
    ruleAttachments: (id: string) => [...queryKeys.packages.all(), "rule-attachments", id] as const,
  },
  exportTemplates: () => [...queryKeys.all, "export-templates"] as const,
  actionLogs: (query: GetActionLogsQuery) => [...queryKeys.all, "action-logs", query] as const,
  classification: {
    ...
    detail: (id: string) => [...queryKeys.classification.all(), "detail", id] as const,
  },
  rules: {
