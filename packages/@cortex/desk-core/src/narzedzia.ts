...
export const KATALOG_NARZEDZI: Record<string, KartaNarzedzia> = Object.fromEntries(
  [
    K({
      nazwa: "lista_plikow",
      klasa: "przeglada",
      trwa: "Przeglądam teczkę",
      ok: "Przejrzałem teczkę",
      grupa: { klucz: "teczka", czasownik: "przejrzałem teczkę", waga: 1 },
      zrodlo: "wbudowane",
    }),
    K({
      nazwa: "czytaj_plik",
    ...
    K({
      ...
      grupa: {
        klucz: "dokument",
        czasownik: "zapisałem",
        liczone: ["dokument", "dokumenty", "dokumentów"],
        waga: 5,
      },
      dowod: { lista: "zrobione", fraza: (n, d) => `zapisano ${n} — ${d}` },
      sprawdzalny: true,
      zrodlo: "wbudowane",
    }),
    K({
      ...
      dowod: { lista: "zrobione", fraza: (n, d) => `zapisano arkusz ${n} — ${d}` },
      sprawdzalny: true,
      zrodlo: "wbudowane",
    }),
    K({
      ...
      grupa: {
        klucz: "obraz",
        czasownik: "narysowałem",
        liczone: ["obraz", "obrazy", "obrazów"],
        waga: 5,
      },
