 ...
 */
export function BezPokrycia({ nazwy, popros }: {
  nazwy: string[]
    ...
    <div className="max-w-miara rounded-lg border border-warn/40 bg-warn-soft px-3.5 py-3">
      <div className="flex items-start gap-2">
        ...
        <div className="min-w-0">
          <p className="t-tresc-m">
            {jeden ? 'Ten plik nie powstał.' : 'Te pliki nie powstały.'}
          </p>
          <p className="mt-0.5 t-meta">
            ...
            {jeden ? ', ale takiego pliku nie ma w teczce sprawy' : ', ale takich plików nie ma w teczce sprawy'}
            {' '}i nie powstał{jeden ? '' : 'y'} w żadnej czynności. To lista tego, co faktycznie się wydarzyło —
