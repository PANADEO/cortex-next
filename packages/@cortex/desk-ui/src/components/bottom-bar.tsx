...
const MENU_ITEMS: { href: string; key: string; icon: LucideIcon }[] = [
  { href: "/", key: "bottomBar.cases", icon: LayoutList },
  { href: "/files", key: "bottomBar.files", icon: FolderOpen },
  { href: "/me", key: "bottomBar.me", icon: CircleUser },
]
      ...
      {MENU_ITEMS.map((p) => {
        ...
        return (
          ...
          >
            ...
            <span className="text-[11px] leading-none">{translate(p.key)}</span>
          </Link>
        )
      })}
    </nav>
